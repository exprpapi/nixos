{
  ...
  outputs =
    ...
    let
      my_username = "u";
      my_hostname = username;
      my_system = "x86_64-linux";
      my_username = "u";
      ...
      nixosConfigurations.${username} = {
        ...
        configuration = {
          ...
          users = {
            ...
            extraGroups = {
              vboxusers.members = [ my_username ];
              docker.members = [ my_username ];
            };
          };
          ...
          nixpkgs = {
            ...
            hostPlatform = lib.mkDefault my_system;
          };
          ...
          # services.getty.autologinUser = my_username;
          
          home-manager = {
            users.${my_username} = { pkgs, ... }: {
              home = {
